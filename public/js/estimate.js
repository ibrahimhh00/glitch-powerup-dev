...
console.log("hello worlddddd")
  ...
  return t
    .set("card", "shared", object_estimateSize)
  ...
  return (
    t
      ...
      .then(function (estimates) {
        ...
        console.log("sss", estimates["card"]["shared"]["backend_estimate"]);
        window.backend_estimateSize.value =
          estimates["card"]["shared"]["backend_estimate"];
        window.frontend_estimateSize.value =
          estimates["card"]["shared"]["frontend_estimate"];
      })
